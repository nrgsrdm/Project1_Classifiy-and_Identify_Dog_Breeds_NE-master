...
# 
def adjust_results4_isadog(sonuc_dic, dogfile):
    """
    ...
    with open(dogfile, "r") as file:
        ...
        while satir!= "":
            ...
            if satir not in dognames_dic:
                dognames_dic[satir] = 1
    ...
    for key in sonuc_dic:
        ...
        if sonuc_dic[key][0] in dognames_dic:
            
            # Classifier Label IS image of Dog (e.g. found in dognames_dic)
            # appends (1, 1) because both labels are dogs
            if sonuc_dic[key][1] in dognames_dic:
                sonuc_dic[key].extend((1, 1))
